...
private val retrofit = Retrofit.Builder()  /*to build retrofit obj */
        .addConverterFactory(MoshiConverterFactory.create(moshi))     /* to build web service api */
        .addCallAdapterFactory(CoroutineCallAdapterFactory())
        .baseUrl(BASE_URL)   /* for web service */
        .build()
